...
pg.mixer.Sound(r"C:\Users\user\Desktop\PP2\Lab_9\racer\background.wav").play(-1)  # Play background sound in a loop
N = 3
...
backgraund = pg.image.load(r"C:\Users\user\Desktop\PP2\Lab_9\racer\AnimatedStreet.png")
...
class Enemy(pg.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = pg.image.load(r"C:\Users\user\Desktop\PP2\Lab_9\racer\Enemy.png")  # Load enemy image
...
class Player(pg.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = pg.image.load(r"C:\Users\user\Desktop\PP2\Lab_9\racer\Player.png")  # Load player image
...
while running:
    ...
    if pg.sprite.spritecollideany(P, enemies):
        pg.mixer.Sound(r"C:\Users\user\Desktop\PP2\Lab_9\racer\crash.wav").play()  # Play crash sound
